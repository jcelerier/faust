...
void remote_dsp_aux::instanceDefaultUserInterface() {}
...
EXPORT void remote_dsp::instanceDefaultUserInterface()
{
    reinterpret_cast<remote_dsp_aux*>(this)->instanceDefaultUserInterface();
}
